    ...
    <div className="bg-[#fafbfc] min-h-screen pt-20 overflow-hidden">
      ...
      <section className="py-24 max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center mb-32">
          ...
          <VideoCard src="https://www.youtube.com/embed/dQw4w9WgXcQ" title="Training with Special Needs" />
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center mb-32">
          ...
          <div className="lg:order-1">
            <div className="bg-white p-4 rounded-[2rem] shadow-xl border border-gray-100">
               <VideoCard src="https://www.youtube.com/embed/dQw4w9WgXcQ" title="Strong Hearts" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            >
              ...
              <VideoCard src="https://www.youtube.com/embed/dQw4w9WgXcQ" title="Flying Kiwi Cup" />
            </motion.div>
            ...
            >
              ...
              <VideoCard src="https://www.youtube.com/embed/dQw4w9WgXcQ" title="Flying Kiwi Formal" />
            </motion.div>
          </div>
        </div>
      </section>
